...
2. Filter mentally to "Open priority 1" and "In-progress with assignee likely active" — surface those to Egon first.
...
The output Egon sees at boot is a one-paragraph summary:
...
That's the resumption surface. Egon knows where to start without re-reading anything else.
